...
<?php endif; ?></span>
    ...
    <div class="stat-value"><?php echo e($stats['total_owners']); ?></div>
    <div class="stat-delta"><?php echo e($stats['trial_owners']); ?> on trial</div>
  </div>
  <div class="stat-card">
    <div class="stat-card-head">
...
<?php endif; ?></span>
    ...
    <div class="stat-value">$<?php echo e(number_format($stats['mrr'],0)); ?></div>
...
<?php endif; ?></span>
    ...
    <div class="stat-value"><?php echo e($stats['total_tenants']); ?></div>
...
<?php endif; ?></span>
    ...
    <?php $tot = $stats['occupied'] + $stats['vacant']; ?>
    <div class="metric-tile-foot"><?php echo e($tot > 0 ? round($stats['occupied'] / $tot * 100, 1) : 0); ?>% occupancy</div>
  </div>
  <div class="metric-tile">
    <div class="metric-tile-top">
      <span class="metric-tile-icon"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
...
<?php endif; ?></span>
  ...
  <div class="metric-tile">
    <div class="metric-tile-top">
      <span class="metric-tile-icon is-success"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?></span>
    ...
    <div class="metric-tile-value">$<?php echo e(number_format($stats['total_revenue'],0)); ?></div>
    <div class="metric-tile-foot">Collected to date</div>
  </div>
  <div class="metric-tile">
    <div class="metric-tile-top">
      <span class="metric-tile-icon <?php echo e($stats['expiring_count']>0?'is-warning':''); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<div class="table-wrap table-stack mb-5">
 <div class="table-scroll">
  ...
  <tbody>
    <?php $__currentLoopData = $planStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      <td data-label="Plan"><b><?php echo e($p->name); ?></b></td>
      <td data-label="Price">$<?php echo e(number_format($p->price_monthly,0)); ?>/mo</td>
      <td data-label="Max Apts"><?php echo e($p->max_apartments); ?></td>
      <td data-label="Active Owners"><?php echo e($p->owners_count); ?></td>
      <td data-label="MRR">$<?php echo e(number_format($p->owners_count * $p->price_monthly,0)); ?></td>
    </tr>
...
<div class="table-wrap table-stack mb-5">
 <div class="table-scroll">
  ...
  <tbody>
    ...
    <tr>
      <td data-label="Owner" class="text-sm"><?php echo e($c->owner?->full_name ?? '—'); ?></td>
      ...
      <td data-label="Days Left">
        ...
        <span class="badge badge-<?php echo e($days <= 7 ? 'danger' : 'warning'); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'clock']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $component = $__componentOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?><?php echo e(max(0,$days)); ?> day<?php echo e($days==1?'':'s'); ?></span>
      </td>
    </tr>
...
<?php $component = $__componentOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?></div><div class="empty-title">No contracts expiring in the next 30 days</div></div>
    </td></tr>
    <?php endif; ?>
  </tbody></table>
 </div>
...
<div class="card-header"><span class="card-title">Recent Owners</span><a href="<?php echo e(route('admin.owners.index')); ?>" class="btn btn-primary btn-sm"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php $component = $__componentOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?> New Owner</a></div>
<div class="table-wrap table-stack">
 <div class="table-scroll">
  <table><thead><tr><th>Owner</th><th>Email</th><th>Plan</th><th>Max Apts</th><th>Status</th><th>Joined</th><th>Actions</th></tr></thead>
  <tbody>
    <?php $__currentLoopData = $recentOwners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
...
<?php endif; ?><?php echo e($o->plan?->name ?? '—'); ?></span></td>
      <td data-label="Max Apts"><?php echo e($o->max_apartments); ?></td>
...
<?php endif; ?><?php echo e(ucfirst($o->status)); ?></span></td>
      ...
      <td data-label="Actions">
        <?php if($o->status==='active'): ?>
          <form method="POST" action="<?php echo e(route('admin.owners.suspend',$o)); ?>" class="d-inline"><?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?><button class="btn btn-outline btn-xs">Suspend</button></form>
        <?php else: ?>
          <form method="POST" action="<?php echo e(route('admin.owners.activate',$o)); ?>" class="d-inline"><?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?><button class="btn btn-gold btn-xs">Activate</button></form>
        <?php endif; ?>
      </td>
    </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\abdirahman\Downloads\SOM_Property_Web_Fixed (1)\som_web\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>