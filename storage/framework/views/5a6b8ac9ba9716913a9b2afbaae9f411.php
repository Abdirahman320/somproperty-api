...
<div class="card">
  ...
  <form method="POST" action="<?php echo e(route('owner.login')); ?>">
    <?php echo csrf_field(); ?>
    <div class="form-group"><label>Email Address</label><input type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="owner@company.com"></div>
  ...
  <div class="footer"><a href="<?php echo e(route('tenant.login')); ?>">Tenant? Sign in here</a></div>
</div></body></html>
<?php /**PATH C:\Users\abdirahman\Downloads\SOM_Property_Web_Fixed (1)\som_web\resources\views/auth/owner-login.blade.php ENDPATH**/ ?>