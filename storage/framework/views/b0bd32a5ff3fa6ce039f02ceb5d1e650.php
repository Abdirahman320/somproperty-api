...
<div class="card">
  ...
  <?php if($errors->any()): ?><div class="alert"><?php echo e($errors->first()); ?></div><?php endif; ?>
  <form method="POST" action="<?php echo e(route('tenant.login')); ?>">
    <?php echo csrf_field(); ?>
    <div class="form-group"><label>Email Address</label><input type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="you@email.com"></div>
  ...
  <div class="footer"><a href="<?php echo e(route('owner.login')); ?>">Property Owner? Sign in here</a></div>
</div></body></html>
<?php /**PATH C:\Users\abdirahman\Downloads\SOM_Property_Web_Fixed (1)\som_web\resources\views/auth/tenant-login.blade.php ENDPATH**/ ?>